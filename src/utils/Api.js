const TOKEN_BACKEND_ORDERS =
  'fF11DSRsLUml9Pvtx8QpC1GF!6e4ze/dSc/R7jZwDBxC15jwwhaerpNYlG5V';
export class Api {
  constructor(options) {
  ...
  search(searchField, searchQuery) {
    fetch(
      `https://shefcheburek.ru/back/search.php?query=${searchQuery}&field=${searchField}`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
